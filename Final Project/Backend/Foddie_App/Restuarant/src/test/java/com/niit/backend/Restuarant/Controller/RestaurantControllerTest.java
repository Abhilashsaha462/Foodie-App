...
public class RestaurantControllerTest {
    ...
    public void setup(){
        ...
        restaurant1 = new Restaurant(101,null,"Vrundavan Multi Cuisine Restaurant","Kalyan", new byte[]{(byte) 204, 29, (byte) 207, (byte) 217},menuList);
        restaurant2 = new Restaurant(102,null,"Gurudev Snacks Corner","Thane",new byte[]{ (byte) 204, 29, (byte) 207, (byte) 217 },menuList);
    ...
    public void trialMethodTest() throws Exception {
        ...
        mockMvc.perform(get("/api/v2/Vrundavan Multi Cuisine Restaurant")).andExpect(status().isFound()).andDo(MockMvcResultHandlers.print());
    }

    @Test
    public void getAllRestaurantList()throws Exception{
        when(restaurantService.getAllRestaurants()).thenReturn(restaurantList);
        mockMvc.perform(get("/api/v2/all")).andExpect(status().isFound()).andDo(MockMvcResultHandlers.print());
    }
